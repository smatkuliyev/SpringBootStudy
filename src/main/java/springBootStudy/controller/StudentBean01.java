...
@Component // bilesen, tamamlayici : kullanilan class'tan obj OIC create eder
// new student() --> bu tight coupling ama @Component loose coupling (obj inject)
public class StudentBean01 implements StudentInterface {
    ...
    @Override
    public String study() {
        return "agam ben StudentBean01 class'indan selam getirmişam :-)";
    }
}
